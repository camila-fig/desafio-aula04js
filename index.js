...
const material = prompt('O material é feito de vidro, aço, cobre ou alumínio?')
...
const deltaL = (T1, T2, L1, material) => {
    ...
    else {prompt('Você não escolheu um material inválido. Tente novamente.')}
}
...
console.log ('Comprimento final = ', L1+deltaL, 'metros')